    ...
    public static ItemDefinition get(int id) {
		...
		case 2424:
            ...
            case 15501:
                ...
                break;
            case 6307:
                itemDef.name = "Spirit shield collection";
                itemDef.actions = new String[5];
                itemDef.actions[0] = "Open";
                itemDef.modelID = 2426;
                break;
            case 6308:
                itemDef.name = "Bandos full set";
                itemDef.actions = new String[5];
                itemDef.actions[0] = "Open";
                itemDef.modelID = 2426;
                break;
            case 6309:
                itemDef.name = "Armadyl full set";
                itemDef.actions = new String[5];
                itemDef.actions[0] = "Open";
                itemDef.modelID = 2426;
                break;
            case 6310:
                itemDef.name = "Glacor Boots set";
                itemDef.actions = new String[5];
                itemDef.actions[0] = "Open";
                itemDef.modelID = 2426;
                break;
            case 6440:
                itemDef.name = "Torva set";
                itemDef.actions = new String[5];
                itemDef.actions[0] = "Open";
                itemDef.modelID = 2426;
                break;
            case 6441:
                itemDef.name = "Pernix set";
                itemDef.actions = new String[5];
                itemDef.actions[0] = "Open";
                itemDef.modelID = 2426;
                break;
            case 6442:
                itemDef.name = "virtus set";
                itemDef.actions = new String[5];
                itemDef.actions[0] = "Open";
                itemDef.modelID = 2426;
                break;
            case 6443:
                itemDef.name = "Nex Collection";
                itemDef.actions = new String[5];
                itemDef.actions[0] = "Open";
                itemDef.modelID = 2426;
                break;
